       ...
       <div class="intro-y grid grid-cols-11 gap-5 mt-5">
           <div class="col-span-12 lg:col-span-4 2xl:col-span-3">
               ...
               <div class="box p-5 rounded-md mt-5">
                   ...
                   <div class="flex items-center"> <i data-lucide="clipboard" class="w-4 h-4 text-slate-500 mr-2"></i> <b>The recipient's name: </b> <a href="" class="underline decoration-dotted ml-1"><?= $invoice->name_P ?></a> </div> 
                   <div class="flex items-center mt-3"> <i data-lucide="clipboard" class="w-4 h-4 text-slate-500 mr-2"></i> <b>Customer</b> <a href="" class="underline decoration-dotted ml-1"><?= $invoice->email ?></a> </div>
               ...
               <div class="box p-5 rounded-md mt-5">
                   ...
                   <div class="flex items-center mt-3"> <i data-lucide="map-pin" class="w-4 h-4 text-slate-500 mr-2"></i> <b>Address:</b>&nbsp; <small><?= $invoice->alamat ?></small> </div>
               </div>
           </div>
