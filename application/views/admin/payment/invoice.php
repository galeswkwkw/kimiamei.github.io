        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
                <div class="flex w-full sm:w-auto">
                    <form action="<?= site_url('admin/invoice/search') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="w-full xl:w-auto flex flex-wrap xl:flex-nowrap items-center gap-y-3 mt-3 xl:mt-0">
                    <a href="<?= site_url('admin/report/reportinvoice') ?>" class="btn btn-danger shadow-md mr-2"> Cetak</a>
                ...
                <table class="table table-report -mt-2">
                    <thead>
                        <tr>
                            ...
                            <th class="whitespace-nowrap">RECIPIENT'S NAME</th>
                    ...
                    <tbody>
                        <?php foreach ($invoice as $row) : ?>
                            <tr class="intro-x">
                                ...
                                <td class="w-40">
                                    <a href="" class="font-medium whitespace-nowrap"><?= $row->name_P ?></a>
                                </td>
                                <td>
