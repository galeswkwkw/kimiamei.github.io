       ...
       <div class="grid grid-cols-12 gap-6 mt-5">
           <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
               <div class="flex w-full sm:w-auto">
                   <form action="<?= site_url('admin/product/search') ?>" method="post" enctype="multipart/form-data">
                       <div class="w-48 relative text-slate-500">
                           <input type="text" name="keyword" class="form-control w-48 box pr-10" placeholder="Search by name...">
               ...
               <div class="w-full xl:w-auto flex flex-wrap xl:flex-nowrap items-center gap-y-3 mt-3 xl:mt-0">
                   ...
                   <a href="<?= site_url('admin/report/reportproduct') ?>" class="btn btn-danger shadow-md mr-2"> Cetak</a>
