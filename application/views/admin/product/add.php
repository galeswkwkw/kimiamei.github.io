                        ...
                        <div class="mt-5">
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-10">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="product-name" name="gambar" type="file" class="form-control" placeholder="Product name" required>
                    ...
                    <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                        ...
                        <div class="mt-5">
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="product-name" type="text" name="nama_brg" class="form-control" placeholder="Product name"required>
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <textarea id="product-name" type="text" name="keterangan" class="form-control" placeholder="Product description"></textarea>
                    ...
                    <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                        ...
                        <div class="mt-5">
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="product-stock" type="number" name="stok" class="form-control" placeholder="Input Product Stock">
                                </div>
                            </div>
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                <div class="form-label xl:w-64 xl:!mr-10">
