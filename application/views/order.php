            ...
            <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
                <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
                    <div class="flex w-full sm:w-auto">
                        <form action="<?= site_url('order/search') ?>" method="post" enctype="multipart/form-data">
                            <div class="w-48 relative text-slate-500">
                                <input type="text" name="keyword" class="form-control w-48 box pr-10" placeholder="Search by inv num ...">
                        ...
                        <?php foreach ($order as $row) : ?>
                            <tr class="intro-x">
                                ...
                                <td class="text-center">
                                    <div class="flex items-center justify-center whitespace-nowrap "> <?= $row->alamat ?>, <?= $row->kode_pos ?> </div>
                                </td>
                                <td>
                                    <div class="flex items-center whitespace-nowrap  text-uppercase"> <i data-lucide="package" class="w-4 h-4 mr-2"></i> <b><?= $row->ekspedisi ?></b> </div>
