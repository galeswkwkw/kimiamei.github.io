    ...
    <div class="mobile-menu md:hidden">
        ...
        <div class="scrollable">
            ...
            <ul class="scrollable__content py-2">
                <li>
                    <a href="<?= site_url('dashboard') ?>" class="menu">
                        <div class="menu__icon"> <i data-lucide="home"></i> </div>
                        <div class="menu__title"> Dashboard </div>
                    </a>
                </li>
                <li>
                    <a href="<?= site_url('order') ?>" class="menu">
                        <div class="menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                        <div class="menu__title"> Order History </div>
                    </a>
                </li>

                <li>
                    <a href="<?= site_url('bill') ?>" class="menu">
                        <div class="menu__icon"> <i data-lucide="file-text"></i> </div>
                        <div class="menu__title"> Billing History </div>
                    </a>
                </li>
                <li>
                    <a href="<?= site_url('pay') ?>" class="menu">
                        <div class="menu__icon"> <i data-lucide="file-text"></i> </div>
                        <div class="menu__title"> Invoice History </div>
                    </a>
                </li>
                <li>
                    <a href="<?= site_url('profile') ?>" class="menu">
                        <div class="menu__icon"> <i data-lucide="settings"></i> </div>
                        <div class="menu__title"> Settings </div>
                    </a>
                </li>
                <li>
                    <a href="<?= site_url('change_password') ?>" class="menu">
