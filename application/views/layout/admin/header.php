    ...
    <div class="mobile-menu md:hidden">
        ...
        <div class="scrollable">
            ...
            <ul class="scrollable__content py-2">
                ...
                <li>
                    <a href="<?= site_url('admin/product') ?>" class="menu">
                        <div class="menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                        <div class="menu__title"> Laporan Data Produk </div>
                    </a>
                </li>

                <li>
                    <a href="<?= site_url('admin/invoice') ?>" class="menu">
                        <div class="menu__icon"> <i data-lucide="file-text"></i> </div>
                        <div class="menu__title"> Laporan Penjualan </div>
                    </a>
                </li>
                <li>
                    <a href="<?= site_url('admin/tabeldata') ?>" class="menu">
                        <div class="menu__icon"> <i data-lucide="user"></i> </div>
                        <div class="menu__title"> Data Pelanggan </div>
                    </a>
                </li>
            </ul>
        </div>
            ...
            <div class="intro-x dropdown w-8 h-8">
                ...
                <div class="dropdown-menu w-56">
                    <ul class="dropdown-content bg-primary/80 before:block before:absolute before:bg-black before:inset-0 before:rounded-md before:z-[-1] text-white">
                        ...
                        <li>
                            <a href="<?= site_url('admin/profile') ?>" class="dropdown-item hover:bg-white/5"> <i data-lucide="user" class="w-4 h-4 mr-2"></i> My Profile </a>
                        </li>
                        <li>
                            <a href="<?= site_url('admin/change_password') ?>" class="dropdown-item hover:bg-white/5"> <i data-lucide="lock" class="w-4 h-4 mr-2"></i> Reset Password </a>
                        </li>
                        <li>
                            <hr class="dropdown-divider border-white/[0.08]">
                        </li>
        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= base_url('admin/tabeldata') ?>" class="side-menu">
