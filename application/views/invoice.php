          ...
          <div class="border-b border-slate-200/60 dark:border-darkmode-400 text-center sm:text-left">
              ...
              <div class="flex flex-col lg:flex-row px-5 sm:px-20 pt-10 pb-10 sm:pb-20">
                  <div>
                      ...
                      <div class="mt-1">The recipient's name: <?= $invoice->name_P ?></div>
                      <div class="mt-1">Customer name: <?= $invoice->name ?></div>
                      
                      <div class="mt-1">The recipient's address: <?= $invoice->alamat ?></div>
                  </div>
                  <div class="lg:text-right mt-10 lg:mt-0 lg:ml-auto">
                      <div class="text-base text-slate-500">Payment From</div>
                      <div class="text-lg font-medium text-primary mt-2">Kimia 52 Shop Commerce</div>
                      <div class="mt-1">kimia52@mail.co.id</div>
                  </div>
              </div>
          </div>
