<div class="content">
                    ...
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
                            ...
                            <div class="intro-y box lg:mt-5">
                                ...
                                <div class="p-5">
                                    <form action="<?= site_url('admin/change_password/process') ?>" method="post">
                                   
                                    <div class="mt-3 mb-4">
                                        <label for="change-password-form-2" class="form-label">New Password</label>
                                        <input id="change-password-form-2" type="password"  name="new_password" class="form-control" autocomplete="off" oninput="validateNIK(this)" required>
                                    ...
                                    <div class="mt-3 mb-4">
                                        ...
                                        <input id="change-password-form-3" name="confirm_password" type="password" class="form-control" autocomplete="off" required>
                                    </div>
                ...
                <script>
                    function validateNIK(input) {
                        ...
                        if (nik.length <= 7) {
                            errorMessage.textContent = 'Please ensure that your password consists of at least 8 characters for enhanced security.';
                        } else {
